...
Cube.prototype.sideChange = function() {
  ...
  if(this.viewport.currentSide == 1){
    //credits
    $('.kave-btn').attr('data-target','#credits');
    boxlink.html('<span class="kave-line"></span>Credits')

  }else if(this.viewport.currentSide == 2){
    //Skills
    $('.kave-btn').attr('data-target','#skills');
    boxlink.html('<span class="kave-line"></span>Skills')

  }else if(this.viewport.currentSide == 3){
    //exper
    $('.kave-btn').attr('data-target','#exper');
    boxlink.html('<span class="kave-line"></span>Experiences')
    

  }else if(this.viewport.currentSide == 4){
    //prof
    $('.kave-btn').attr('data-target','#profiles');
    boxlink.html('<span class="kave-line"></span>Profiles')
    

  }else if(this.viewport.currentSide == 5){
    //hobbies
    $('.kave-btn').attr('data-target','#hobbies');
    boxlink.html('<span class="kave-line"></span>Projects')
    

  }else if(this.viewport.currentSide == 6){
    //prologue
    $('.kave-btn').attr('data-target','#prologue');
    boxlink.html('<span class="kave-line"></span>Prologue')
